...
sendVarToJS('eqType', 'yamahaavr');
$eqLogics = eqLogic::byType('yamahaavr');
?>
...
foreach ($eqLogics as $eqLogic) {
	...
	echo "<center>";
	echo '<img src="plugins/yamahaavr/doc/images/yamahaavr_icon.png" height="105" width="95" />';
	echo "</center>";
  ...
  <form class="form-horizontal">
    <fieldset>
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label">{{Nom de l'équipement Yamaha}}</label>
        <div class="col-sm-3">
          <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
          <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement Yamaha}}"/>
        </div>
      </div>
      <div class="form-group">
...
<legend>{{Commandes Yamaha}}</legend>
...
<?php include_file('desktop', 'yamahaavr', 'js', 'yamahaavr');?>
